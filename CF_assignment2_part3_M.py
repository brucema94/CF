...
for i in range(IterationIndex): 
    ...
    CV = Control_variate(S0, r, sigma, T, N, Iteration[i], K)
...
plotP.plot(Iteration, CV_estimate[:,0],label = "Control Variate")
...
plotQ.plot(Iteration, CV_estimate[:,1],label = "Control_Variate_error")
